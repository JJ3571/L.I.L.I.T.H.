...
- `OPENCODE_MODEL` (string, optional) — OpenCode Go model id (default `glm-5.3-flash`). Examples: `kimi-k2.6`, `qwen3.6-plus`, `mimo-v2.5`. DeepSeek V4 models may return a region error unless opted in on your OpenCode workspace.
